...
class UF2Block:
    ...
    def __init__(self, block_data:bytearray,
            ...
            self.file_size_or_board_id = file_size_or_board_id
    ...
    def from_block(cls, block_data):
        ...
        file_size_or_board_id = struct.unpack('<I', block_data[28:32])[0]
        ...
        return cls(block_data=block_data,
            ...
            file_size_or_board_id=file_size_or_board_id, 
            payload_data=payload_data
        )

    def from_contents(cls, flags, address, payload_size_bytes, block_number, total_blocks, file_size_or_board_id, payload_data):
        """
        ...
        @param[in] file_size_or_board_id ID of board to flash to.
        ...
        struct.pack_into('<I', block_data, 28, 0)  # file size/family ID

        block_data.extend(payload_data[0:payload_size_bytes])
        block_data.extend([0 for i in range(cls.UF2_PAYLOAD_MAX_SIZE_BYTES - payload_size_bytes)])

        struct.pack_into('<I', block_data, cls.UF2_BLOCK_SIZE_BYTES - 4, cls.UF2_MAGIC_END)
