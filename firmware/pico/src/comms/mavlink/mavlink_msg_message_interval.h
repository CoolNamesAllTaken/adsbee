...
typedef struct __mavlink_message_interval_t {
    int32_t interval_us; /*< [us] The interval between two messages. A value of -1 indicates this stream is disabled, 0
 ...
 * @param interval_us [us] The interval between two messages. A value of -1 indicates this stream is disabled, 0
 * indicates it is not available, > 0 indicates the interval at which it is sent.
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_message_interval_pack(uint8_t system_id, uint8_t component_id,
                                                         mavlink_message_t* msg, uint16_t message_id,
                                                         int32_t interval_us) {
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_MESSAGE_INTERVAL_MIN_LEN,
                                    MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN, MAVLINK_MSG_ID_MESSAGE_INTERVAL_CRC);
}
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_message_interval_pack_status(uint8_t system_id, uint8_t component_id,
    ...
    return mavlink_finalize_message_buffer(msg, system_id, component_id, _status,
                                           MAVLINK_MSG_ID_MESSAGE_INTERVAL_MIN_LEN, MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN,
...
static inline uint16_t mavlink_msg_message_interval_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
    ...
    msg->msgid = MAVLINK_MSG_ID_MESSAGE_INTERVAL;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_MESSAGE_INTERVAL_MIN_LEN,
                                         MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN, MAVLINK_MSG_ID_MESSAGE_INTERVAL_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_message_interval_encode(uint8_t system_id, uint8_t component_id,
                                                           mavlink_message_t* msg,
                                                           const mavlink_message_interval_t* message_interval) {
    return mavlink_msg_message_interval_pack(system_id, component_id, msg, message_interval->message_id,
 ...
 * @param message_interval C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_message_interval_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
                                                                mavlink_message_t* msg,
                                                                const mavlink_message_interval_t* message_interval) {
    return mavlink_msg_message_interval_pack_chan(system_id, component_id, chan, msg, message_interval->message_id,
                                                  message_interval->interval_us);
}
 ...
 * @param message_interval C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_message_interval_encode_status(uint8_t system_id, uint8_t component_id,
                                                                  mavlink_status_t* _status, mavlink_message_t* msg,
                                                                  const mavlink_message_interval_t* message_interval) {
    return mavlink_msg_message_interval_pack_status(system_id, component_id, _status, msg, message_interval->message_id,
                                                    message_interval->interval_us);
}
...
static inline void mavlink_msg_message_interval_send(mavlink_channel_t chan, uint16_t message_id, int32_t interval_us) {
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MESSAGE_INTERVAL, buf, MAVLINK_MSG_ID_MESSAGE_INTERVAL_MIN_LEN,
                                    MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN, MAVLINK_MSG_ID_MESSAGE_INTERVAL_CRC);
#else
    mavlink_message_interval_t packet;
    packet.interval_us = interval_us;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MESSAGE_INTERVAL, (const char*)&packet,
                                    MAVLINK_MSG_ID_MESSAGE_INTERVAL_MIN_LEN, MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN,
                                    MAVLINK_MSG_ID_MESSAGE_INTERVAL_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_message_interval_send_struct(mavlink_channel_t chan,
                                                            const mavlink_message_interval_t* message_interval) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_message_interval_send(chan, message_interval->message_id, message_interval->interval_us);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MESSAGE_INTERVAL, (const char*)message_interval,
                                    MAVLINK_MSG_ID_MESSAGE_INTERVAL_MIN_LEN, MAVLINK_MSG_ID_MESSAGE_INTERVAL_LEN,
                                    MAVLINK_MSG_ID_MESSAGE_INTERVAL_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_message_interval_send_buf(mavlink_message_t* msgbuf, mavlink_channel_t chan,
                                                         uint16_t message_id, int32_t interval_us) {
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 *
 * @return [us] The interval between two messages. A value of -1 indicates this stream is disabled, 0 indicates it is
