...
RF_Mode RF_prop = {
    .rfMode = RF_MODE_AUTO, .cpePatchFxn = &rf_patch_cpe_multi_protocol, .mcePatchFxn = 0, .rfePatchFxn = 0};
...
uint32_t pOverrides[] = {
    ...
    // leaves the PA unable to reach its operating point — crippling UAT TX output.
...
rfc_CMD_PROP_RADIO_DIV_SETUP_t RF_cmdPropRadioDivSetup = {.commandNo = 0x3807,
                                                          .status = 0x0000,
...
rfc_CMD_PROP_RX_ADV_t RF_cmdPropRxAdv = {
    ...
    .syncWord1 = 0x53225B1D,  // Overridden at runtime by SubGHzRadio::Init() (0 when uplink RX is disabled).
    .maxPktLen = 0x00FF,
