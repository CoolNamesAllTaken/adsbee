...
GPIO_PinConfig gpioPinConfigs[48] = {
    ...
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_NONE_INTERNAL, /* RSUBG_LED */
    /* Owned by SUBG_UART as RX */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_UP_INTERNAL | GPIO_CFG_HYSTERESIS_ON, /* SUBG_UART_RX */
    /* Owned by SUBG_UART as TX */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_HIGH, /* SUBG_UART_TX */
    GPIO_CFG_NO_DIR, /* DIO_4 */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_RISING | GPIO_CFG_PULL_DOWN_INTERNAL, /* SYNC */
    GPIO_CFG_NO_DIR, /* DIO_6 */
    GPIO_CFG_NO_DIR, /* DIO_7 */
    /* Owned by COPRO_SPI as POCI */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_NONE_INTERNAL, /* COPRO_SPI_POCI */
    /* Owned by COPRO_SPI as PICO */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_DOWN_INTERNAL, /* COPRO_SPI_PICO */
    ...
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* SUBG_DIO26 */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* SUBG_DIO27 */
...
const uint_least8_t SUBG_DIO26_CONST = SUBG_DIO26;
const uint_least8_t LR_CS_CONST = LR_CS;
const uint_least8_t LR_BUSY_CONST = LR_BUSY;
const uint_least8_t LR_RESET_CONST = LR_RESET;
...
const uint_least8_t SUBG_UART_TX_CONST = SUBG_UART_TX;
const uint_least8_t SUBG_UART_RX_CONST = SUBG_UART_RX;
...
const SPICC26X4DMA_HWAttrs spiCC26X4DMAHWAttrs[CONFIG_SPI_COUNT] = {
    /* COPRO_SPI */
    {
        ...
        .picoPin = COPRO_SPI_PICO,
        .pociPin = COPRO_SPI_POCI,
        .clkPin  = COPRO_SPI_SCLK,
...
const SPI_Config SPI_config[CONFIG_SPI_COUNT] = {
    /* COPRO_SPI */
    {
        ...
        .object = &spiCC26X4DMAObjects[COPRO_SPI],
        .hwAttrs = &spiCC26X4DMAHWAttrs[COPRO_SPI]
    },
};
...
const UART2_Config UART2_config[CONFIG_UART2_COUNT] = {
    {   /* SUBG_UART */
        .object      = &uart2CC26X2Objects[SUBG_UART],
        .hwAttrs     = &uart2CC26X2HWAttrs[SUBG_UART]
    },
};

const uint_least8_t SUBG_UART_CONST = SUBG_UART;
