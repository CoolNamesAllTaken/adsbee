...
constexpr int NB = 12;  // Coarse

// Precalculated Constants for NB == 12 (Coarse)
constexpr int_type pow232nb1 = 2097152;  // = 2^(32-(NB-1))
constexpr int_type pow232nb = 1048576;   // = 2^(32-NB)
constexpr int_type pow2nb1 = 2048;       // = 2^(NB-1)
constexpr int_type pow2nb = 4096;        // = 2^NB
constexpr int sub32nb = 20;              // = 32-NB
constexpr int minNB17 = 12;              // = min(NB,17)
constexpr int_type pow2mnb116 = 2048;    // = min(2^(NB-1),2^16)
constexpr int_type pow2c31mb = 524288;
