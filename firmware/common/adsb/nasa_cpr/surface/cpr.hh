 ...
 * @param[in] own_lat_awb The ownship latitude in AWB format (needed for surface positions).
 * @return Recovered position.
 */
recovered_position global_dec(int i, message msg0, message msg1, int_type own_lat_awb);
