...
constexpr int NB = 19;  // Surface

// Precalculated Constants for NB == 19 (Surface)
constexpr int_type pow232nb1 = 16384;   // = 2^(32-(NB-1))
constexpr int_type pow232nb = 8192;     // = 2^(32-NB)
constexpr int_type pow2nb1 = 262144;    // = 2^(NB-1)
constexpr int_type pow2nb = 524288;     // = 2^NB
constexpr int sub32nb = 13;             // = 32-NB
constexpr int minNB17 = 17;             // = min(NB,17)
constexpr int_type pow2mnb116 = 65536;  // = min(2^(NB-1),2^16)
constexpr int_type pow2c31mb = 4096;
