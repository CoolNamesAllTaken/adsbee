...
constexpr int NB = 14;  // Intent

// Precalculated Constants for NB == 14 (Intent)
constexpr int_type pow232nb1 = 524288;  // = 2^(32-(NB-1))
constexpr int_type pow232nb = 262144;   // = 2^(32-NB)
constexpr int_type pow2nb1 = 8192;      // = 2^(NB-1)
constexpr int_type pow2nb = 16384;      // = 2^NB
constexpr int sub32nb = 18;             // = 32-NB
constexpr int minNB17 = 14;             // = min(NB,17)
constexpr int_type pow2mnb116 = 8192;   // = min(2^(NB-1),2^16)
constexpr int_type pow2c31mb = pow217;
