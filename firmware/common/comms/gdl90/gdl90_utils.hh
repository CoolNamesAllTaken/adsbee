...
/**
 * Write a payload to a buffer, automatically adding escape sequences as required. Everything except for start and end
 * of message flags should be passed in as part of the payload.
