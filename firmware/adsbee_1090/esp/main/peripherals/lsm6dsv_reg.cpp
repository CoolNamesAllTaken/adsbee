...
int32_t lsm6dsv_den_conf_get(const stmdev_ctx_t *ctx, lsm6dsv_den_conf_t *val)
{
  ...
  {
    case lsm6dsv_den_conf_t::LSM6DSV_LEVEL_TRIGGER:
      val->mode = lsm6dsv_den_conf_t::LSM6DSV_LEVEL_TRIGGER;
      break;

    case lsm6dsv_den_conf_t::LSM6DSV_LEVEL_LATCHED:
      val->mode = lsm6dsv_den_conf_t::LSM6DSV_LEVEL_LATCHED;
      break;

    default:
      val->mode = lsm6dsv_den_conf_t::LSM6DSV_DEN_NOT_DEFINED;
      break;
  }
