...
class uat_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "uat_receiver")
        ...
        # Variables
        ##################################################
        self.xfir_decimation = xfir_decimation = 3
        self.xfir_bw_hz = xfir_bw_hz = 900e3
        self.samp_rate = samp_rate = 3e6
        self.fsk_deviation_hz = fsk_deviation_hz = 1e6
        self.freq = freq = 978e6
        ...
        self.qtgui_freq_sink_x_0_0.set_trigger_mode(qtgui.TRIG_MODE_FREE, -90, 0, "")
        ...
        self.qtgui_freq_sink_x_0.set_trigger_mode(qtgui.TRIG_MODE_NORM, -90, 0, "")
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1,  firdes.low_pass(1,samp_rate,samp_rate/(2*xfir_decimation), xfir_bw_hz), freq, samp_rate)
        self.digital_binary_slicer_fb_0 = digital.binary_slicer_fb()
        self.blocks_uchar_to_float_0 = blocks.uchar_to_float()
        self.analog_simple_squelch_cc_0_0 = analog.simple_squelch_cc((-40), 1)
        self.analog_quadrature_demod_cf_0_0 = analog.quadrature_demod_cf(10)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_quadrature_demod_cf_0_0, 0), (self.digital_binary_slicer_fb_0, 0))
        self.connect((self.analog_simple_squelch_cc_0_0, 0), (self.analog_quadrature_demod_cf_0_0, 0))
        self.connect((self.analog_simple_squelch_cc_0_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.analog_simple_squelch_cc_0_0, 0), (self.qtgui_waterfall_sink_x_0_0, 0))
    ...
    def get_xfir_decimation(self):
        return self.xfir_decimation

    def set_xfir_decimation(self, xfir_decimation):
        self.xfir_decimation = xfir_decimation
        self.freq_xlating_fir_filter_xxx_0.set_taps( firdes.low_pass(1,self.samp_rate,self.samp_rate/(2*self.xfir_decimation), self.xfir_bw_hz))

    def get_xfir_bw_hz(self):
        return self.xfir_bw_hz

    def set_xfir_bw_hz(self, xfir_bw_hz):
        self.xfir_bw_hz = xfir_bw_hz
        self.freq_xlating_fir_filter_xxx_0.set_taps( firdes.low_pass(1,self.samp_rate,self.samp_rate/(2*self.xfir_decimation), self.xfir_bw_hz))
...
def main(top_block_cls=uat_receiver, options=None):
